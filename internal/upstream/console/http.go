...
func (c *ConsoleUpstream) buildHeaders(token string) http.Header {
...
func (c *ConsoleUpstream) buildRequest(ctx context.Context, token string, body []byte) (*http.Request, error) {
