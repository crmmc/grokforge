...
func DefaultConfig() *Config {
	return &Config{
		...
		Token: TokenConfig{
			...
			BasicModels: []string{
				"grok-4.20-fast", "grok-4.20-auto", "grok-4.20-expert#4",
				"grok-4.20-0309-non-reasoning", "grok-4.20-0309", "grok-4.20-0309-reasoning#4",
				"grok-imagine-image-lite",
			},
			SuperModels: []string{
				"grok-4.20-fast", "grok-4.20-auto", "grok-4.20-expert#4",
				"grok-4.20-0309-non-reasoning", "grok-4.20-0309", "grok-4.20-0309-reasoning#4",
				"grok-4.20-0309-non-reasoning-super", "grok-4.20-0309-super", "grok-4.20-0309-reasoning-super#4",
				"grok-imagine-image-lite", "grok-imagine-image", "grok-imagine-image-edit",
				"grok-imagine-video",
			},
